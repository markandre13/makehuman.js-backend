...
class HolisticDevice_impl : public virtual HolisticDevice_skel, public virtual LocalCaptureDevice {
    protected:
        std::shared_ptr<HolisticReceiver> _receiver;

    public:
        CORBA::async<std::shared_ptr<HolisticReceiver>> receiver() override;
        CORBA::async<void> receiver(std::shared_ptr<HolisticReceiver>) override;
};